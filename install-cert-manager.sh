...
kubectl --kubeconfig="$config_path" apply --validate=false -f https://github.com/jetstack/cert-manager/releases/download/v0.15.0-beta.0/cert-manager-legacy.crds.yaml